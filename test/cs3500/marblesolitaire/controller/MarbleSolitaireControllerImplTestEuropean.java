 ...
 */
public class MarbleSolitaireControllerImplTestEuropean {
  ...
  public void testRenderMessage() throws IOException {
    view = new MarbleSolitaireTextView(new EuropeanSolitaireModel(), new CorruptClass());
    try {
  ...
  public void testRenderMessage2() throws IOException {
    view = new MarbleSolitaireTextView(new EuropeanSolitaireModel(3), new CorruptClass());
    try {
  ...
  public void testRenderMessage3() throws IOException {
    view = new MarbleSolitaireTextView(new EuropeanSolitaireModel(3,5), new CorruptClass());
    try {
  ...
  public void testRenderMessage4() throws IOException {
    view = new MarbleSolitaireTextView(new EuropeanSolitaireModel(3,3,5), new CorruptClass());
    try {
      view.renderMessage("see ya");
      fail("exception thrown");
    } catch (IOException e) {
